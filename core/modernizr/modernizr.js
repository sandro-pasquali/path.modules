...
/*
	@spasquali: 	The original file passes this SIF `this` implying `window` and `this.document` 
					implying `document`. However, `this` here is our module scope. So, changed
					the call params, at bottom of file, to `window` and `document` explicitly.
*/
