...
//	We're using native methods throughout this module, for the most part. 
//	Want to bind to the actual $view DOM node.
//
...
function createEventBindings( on ) {
	...
	view.addEventListener('keyup', checkTextHighlighting);

	// Mouse bindings
	view.addEventListener('mousedown', checkTextHighlighting);
...
function getWordCount() {
	...
	var text = jQuery(contentField).text();
...
path.set('module-core/focused-writing.initEditor', init);
path.set('module-core/focused-writing.getWordCount', getWordCount);
